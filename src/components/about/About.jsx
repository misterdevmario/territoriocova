      ...
      <div className="about_cards-container">
        <div className="card1">
          <div className="card-name-container1">
            <h1>MISIÓN</h1>
            <p>
              BRINDAR UNA ASESORIA INTEGRAL Y PERSONALIZADA A MILES DE MEXICANOS EN BUSCA DE UN HOGAR PARA SUS FAMILIAS, PERMIRIENDOLES APROVECHAR AL MÁXIMO SUS POSIBILIDADES. SER EL VALOR AGREGADO A TU PATRIMONIO Y AHORROS PARA JUNTOS ENCONTRAR LA VIVIENDA IDEAL A TUS NECESIDADES Y ALCANCES. SOMOS LA LLAVE DE TU HOGAR.
            </p>
          </div>
